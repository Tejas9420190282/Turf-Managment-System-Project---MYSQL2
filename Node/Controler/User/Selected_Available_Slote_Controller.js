...
const selected_Available_Slote_Controller = async (req, res) => {
    try {
        ...
        const [booked_Slote] = await mySqlConnectionPool.query(
            "SELECT t.TURF_Id, t.turf_name, t.area, t.city, t.pincode, t.light, t.price_hr, t.equipment, t.image_URL, s.slote_id, s.start_time, s.end_time FROM turf t LEFT JOIN slote s ON t.TURF_Id = s.turf_id WHERE t.TURF_Id = ? AND s.slote_id = ?",
            [turfid, sloteid]
        );
