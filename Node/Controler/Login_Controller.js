...
const login_Controller = async (req, res) => {
    try {
        ...
        const [adminResult] = await mySqlConnectionPool.query(
        ...
        if (admin) {
            if (password == admin.password) {
                ...
                console.log();
                console.log("Successfully Logged in as Admin!".bgGreen);
                ...
                console.log(
                    "Incorrect Password, Please Enter Valid Password".bgRed
                );
        ...
        console.log(
            `Error in signUp_Controller API : , ${error.message}`.bgRed
        );
